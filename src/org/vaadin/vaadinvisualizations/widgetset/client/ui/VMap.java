...
public class VMap extends VVisualizationWidget {
	...
	public VMap() {
		...
		ApplicationConnection.getConsole().log("VMap init");
	...
	protected void drawChart(AbstractDataTable data, AbstractDrawOptions options) {
		ApplicationConnection.getConsole().log(
				"VMap draw " + data.getNumberOfRows()
						+ " with options as follows" + options.toString());
		if (chart != null) {
			remove(chart);
		}
		
		chart = new MapVisualization(data, (Options) options, "500", "500");
