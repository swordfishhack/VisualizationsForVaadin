...
public class VAnnotatedTimeLine extends VCommonVisualizationWidget {
	...
	public static final String TAGNAME = "annotatedtimeline";
	...
	public VAnnotatedTimeLine() {
		...
		ApplicationConnection.getConsole().log("VAnnotatedTimeLine init");
	...
	protected Options createOptions() {
		ApplicationConnection.getConsole().log(
				"VAnnotatedTimeLine createOptions");
